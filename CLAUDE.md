...
Format: a one-line intro followed by a bullet per fix. Each bullet must be:
- Short and concise — one sentence maximum
- Understandable by an average RimWorld player with no modding knowledge
- Named by the UI element affected (search box, storage tab, architect menu)
